...
return array(
	...
	'db' => array(  // 数据库连接配置
		...
		'port' => 3306,        // 端口
		'login' => 'vdumes',     // 用户名
		'password' => 't28RdhKeDvqe9Tj6',      // 密码
		'database' => 'extmail',      // 库名称
		'prefix' => '',           // 表前缀
	...
	'view' => array( // 视图配置
		'enabled' => TRUE, // 开启视图
		'config' =>array(
			'template_dir' => APP_PATH.'/templates/2013', // 模板目录
			'compile_dir' => APP_PATH.'/templates_c', // 编译目录
	...
	'lang' => array(
		'en' => 'default',
		'zh_CN' => APP_PATH."/languages/zh_CN/lang.php",
		'ja' => APP_PATH."/languages/ja/lang.php",
	), // 多语言设置，键是每种语言的名称，而值可以是default（默认语言），语言文件地址或者是翻译函数
	...
	//'ext' => array(), // 扩展使用的配置根目录
        'ext' => array(
            'spVerifyCode' => array( //验证码扩展
                    ...
                    'noisenum' => 50, //图像噪点数量
                    'fontsize' => 18, //字体大小
                    'fontfile' => 'verdana.ttf', //字体文件
                    'format' => 'gif', //验证码输出图片格式
            ),
			'spAcl' => array( // acl扩展设置
				'prompt' => array("lib_manager1", "acljump"),
			), 
        ),
        'launch' => array( 'router_prefilter' => array(
