...
class spController { 
    ...
    public function error($msg, $url = ''){
		...
		echo "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><link type=\'text\/css\' rel=\'stylesheet\ href=\'./public/css/{$_SESSION['lang']}/global.css\'><script>function sptips(){alert(\"{$msg}\");{$url}}</script></head><body onload=\"sptips()\"></body></html>";
		exit;
    }
